...
def contact(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request, 'You have already make enquiry for this listing')
                return redirect('/listings/'+listing_id+'/listing/')
        ...
        send_mail(
            ...
            [realtor_email, 'ifeoluwa.odewale@gmail.com'],
            fail_silently=False,
        )
